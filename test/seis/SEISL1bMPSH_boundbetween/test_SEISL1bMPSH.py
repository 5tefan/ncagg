...
from ncagg.aggregator import generate_aggregation_list, evaluate_aggregation_list, FillNode
...
class TestMpsh(unittest.TestCase):
    ...
    def test_mpsh_with_config(self):
        ...
        with nc.Dataset(self.nc_out_filename) as nc_out:  # type: nc.Dataset
            start_time_num, end_time_num = nc.date2num([start_time, end_time], nc_out["L1a_SciData_TimeStamp"].units)
